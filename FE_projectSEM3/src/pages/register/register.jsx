...
const Register = () => {
  ...
  return (
    <>
      ...
      <div id='login'>
        <div className="container">
          <div className="left-panel left-panels">
            <img src='/im-register.jpg'/>
          </div>
          <div className="right-panel right-panels">
            <div className="form-container">
              <h2 style={{textAlign:"center"}}>Register</h2>
              <Form form={form} onFinish={handleSignUp}>
                <Form.Item
                ...
                <Form.Item
                  ...
                  labelCol={{ span: 24 }}
                >
                  <Input.Password size="large" value={confirmPassword} onChange={(e) => handleChangeInput(e, 'confirmPassword')} />
                </Form.Item>
                <Form.Item
                  label="Phone"
                  name="phone"
                ...
                <button type="submit" className='signup-btn signup-btns'>
                  Register
                </button>
              </Form>
              <div className='login-link'>
